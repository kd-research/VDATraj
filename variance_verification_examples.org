...
#+PROPERTY: header-args:R :prologue "source(\"prelude/controlled_example.R\");" :colnames yes
...
#+begin_src R :results output graphics file :file ./plots/controlled_example_plot.png :width 1600 :height 1600 :res 200
...
[[file:./plots/controlled_example_plot.png]]

* Experiment 2: Negative Control - Parameter Independence
#+PROPERTY: header-args:R :prologue "source(\"prelude/uncontrolled_example.R\");" :colnames yes
...
#+begin_src R :results output graphics file :file ./plots/uncontrolled_example_plot.png :width 1600 :height 1600 :res 200
# Compute difference variables for plotting
same_param_diff <- uncontrolled_df$base_h - uncontrolled_df$truthy_h
random_param_diff <- uncontrolled_df$base_h - uncontrolled_df$random_h
same_param_variance <- var(same_param_diff)
...
[[file:./plots/uncontrolled_example_plot.png]]

* Experiment 3: Demonstrating Method Superiority - Non-Linear Relationships
#+PROPERTY: header-args:R :prologue "source(\"prelude/sinusoidal_example.R\");" :colnames yes
...
#+begin_src R :results output graphics file :file ./plots/cosine_example_plot.png :width 1600 :height 1600 :res 200
...
[[file:./plots/cosine_example_plot.png]]

* Experiment 4: Applied Case Study - Trajectory Dynamics
#+PROPERTY: header-args:R :prologue "source(\"prelude/trajectory_example.R\");" :colnames yes
...
#+begin_src R :results output graphics file :file ./plots/trajectory_example_plot.png :width 1600 :height 1600 :res 200
# Compute difference variables for plotting
same_param_diff <- trajectory_df$base_collision_times - trajectory_df$truthy_collision_times
random_param_diff <- trajectory_df$base_collision_times - trajectory_df$random_collision_times
same_param_variance <- var(same_param_diff)
...
[[file:./plots/trajectory_example_plot.png]]

* Comprehensive Results and Method Validation
#+PROPERTY: header-args:R :prologue "source(\"prelude/verification_examples.R\");" :colnames yes

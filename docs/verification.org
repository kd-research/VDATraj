...
#+PROPERTY: header-args:R :prologue "source(\"examples/01_controlled_example.R\");" :colnames yes
...
Dataset contains 15000 simulation runs
...
#+PROPERTY: header-args:R :prologue "source(\"examples/02_uncontrolled_example.R\");" :colnames yes
...
--- Theoretical vs Observed ---
Expected noise component (2σ²): 1.28
...
#+PROPERTY: header-args:R :prologue "source(\"examples/03_sinusoidal_example.R\");" :colnames yes
...
#+PROPERTY: header-args:R :prologue "source(\"examples/04_trajectory_example.R\");" :colnames yes
...
[1] "Number of simulation runs: 15000"
...
'data.frame':	15000 obs. of  6 variables:
 ...
 $ random_delay_time     : num  0.0981 0.1237 0.4668 0.6431 0.0339 ...
 $ base_collision_times  : num  31 33 59 73 56 30 61 68 77 93 ...
 $ truthy_collision_times: num  41 58 114 114 45 31 97 96 53 48 ...
 $ random_collision_times: num  62 37 27 112 71 32 39 39 34 70 ...
#+end_example
...
Measurement: Collision times from trajectory simulations
  Range: 0 to 144
Base variance Var(collision_times): 634.751
Same parameter variance: 875.017
Random parameter variance: 1131.696
Impact variance (delay time effect): 256.679
...
✓ SIGNIFICANT: Visual perception delay time influences collision times
  ...
  Effect size:  0.29 x simulation noise
...
#+PROPERTY: header-args:R :prologue "source(\"examples/run_all_verifications.R\");" :colnames yes
